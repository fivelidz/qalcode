...
import { DialogAgentMonitor } from "@tui/component/dialog-agent-monitor"
import { DialogTasks } from "@tui/component/dialog-tasks"
import { DialogProcesses } from "@tui/component/dialog-processes"
...
function App() {
  ...
  command.register(() => [
    ...
    {
      title: "Agent monitor",
      value: "monitor.agents",
      keybind: "agent_monitor" as any,
      category: "Monitor",
      onSelect: () => {
        dialog.replace(() => <DialogAgentMonitor />)
      },
    },
    {
      title: "Task list",
      value: "monitor.tasks",
      keybind: "task_list" as any,
      category: "Monitor",
      suggested: true,
      onSelect: () => {
    ...
    },
    {
      ...
      value: "monitor.processes",
      keybind: "process_viewer" as any,
      category: "Monitor",
      onSelect: () => {
        dialog.replace(() => <DialogProcesses />)
      },
    },
    {
